...
public class Database {
    ...
    /**
     * <p>
     * First invokes the lookupByName() method to search for the given
     * name and get its index, or -1 if it isn't found. If the index is -1,
     * then the Person is not removed and a null Person is returned. Otherwise,
     * the Person at that index is removed from the storage and the Person is
     * returned.
     * </p>
     * 
     * @param name the name of the Person object to be removed
     * @return the Person object that is removed, or a null Person
     */
