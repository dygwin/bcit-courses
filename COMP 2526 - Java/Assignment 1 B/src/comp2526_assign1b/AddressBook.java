...
/**
 * <p>
 * The AddressBook class handles querying the database to store, retrieve,
 * and remove People objects from the database. It has methods to add,
 * delete, and find People objects in the database. It also has many
 * support methods for these main functions, as well as methods to display
 * Person object's data.
 * </p>
 * 
...
public class AddressBook {
    ...
    public void addPerson() {
        ...
        if (search(person.getName()) == null) {
            database.add(person);
            ui.displayMsg("\n" + person.getName() + " was added successfully");
        } else {
            ui.displayErrorMsg("\n" + person.getName() + " already exists");
        }
    }
    ...
    public void deletePerson() {
        ...
        // whether or not the name was successfully removed
        boolean removed = remove(name);
    ...
    public void displayAll() {
        // a Person array containing every Person object in the database
        Person[] people = database.getAll();
        
        ui.displayAll(people);
    }
